...
public class ValueButtons {
    private static final ResourceLocation add = JustDireThings.id("textures/gui/buttons/add.png");
    private static final ResourceLocation subtract = JustDireThings.id("textures/gui/buttons/remove.png");
