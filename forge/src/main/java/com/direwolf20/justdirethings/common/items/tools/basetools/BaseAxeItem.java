...
public class BaseAxeItem extends AxeItem implements ToggleableTool, LeftClickableTool {
    protected final EnumSet<Ability> abilities = EnumSet.noneOf(Ability.class);
    protected final Map<Ability, AbilityParams> abilityParams = new EnumMap<>(Ability.class);

    public BaseAxeItem(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public <T extends LivingEntity> int damageItem(ItemStack stack, int amount, @Nullable T entity, Consumer<T> onBroken) {
        return defaultDamage(stack,amount,entity,onBroken);
    }

    public static <T extends LivingEntity> int defaultDamage(ItemStack stack, int amount, @Nullable T entity, Consumer<T> onBroken) {
