...
public class BasePaxelItem extends BasePickaxeItem {

    public BasePaxelItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if (context.getClickedFace() != Direction.DOWN) {
            ...
            } else if ((blockstate2 = blockstate.getToolModifiedState(context, ToolActions.SHOVEL_DIG, false)) != null) {
    ...
    public boolean canPerformAction(ItemStack stack, ToolAction toolAction) {
        return super.canPerformAction(stack,toolAction) || ToolActions.DEFAULT_AXE_ACTIONS.contains(toolAction) || ToolActions.DEFAULT_SHOVEL_ACTIONS.contains(toolAction);
    }
