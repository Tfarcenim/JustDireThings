...
public class JustDireItemModels extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent(Registration.TIME_CRYSTAL_BUDDING_BLOCK.getId().getPath(), modLoc("block/time_crystal_budding_block_state_0"));
        ...
        //singleTexture(Registration.CreatureCatcherItem.getId().getPath() + "_base", mcLoc("item/generated"), "layer0", modLoc("item/creaturecatcher"));
