...
public class FluidStackNBTHandler implements IFluidHandlerItem {
    ...
    /**
         ...
         */
    public FluidStackNBTHandler(@NotNull ItemStack container, int capacity,String key)
        {
        ...
        public FluidStack getFluid()
        {
            ...
            if (tagCompound == null || !tagCompound.contains(key))
            {
                return FluidStack.EMPTY;
            }
            return FluidStack.loadFluidStackFromNBT(tagCompound.getCompound(key));
        }
        ...
        protected void setFluid(FluidStack fluid)
        {
            ...
            container.getTag().put(key, fluidTag);
        }
